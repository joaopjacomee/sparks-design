    ...
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-glass bg-background/80 border-b border-border">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/5588921751396?text=Ol%C3%A1%21%20Vim%20pelo%20site%20da%20Sparks%20e%20gostaria%20de%20saber%20mais%20sobre%20seus%20servi%C3%A7os.",
              "_blank"
            )
          }
        >
